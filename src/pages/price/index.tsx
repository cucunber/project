  ...
  return (
    <Container {...container}>
      ...
      >
        ...
        <Paragraph paragraph="Обратите внимание, приведенные ниже цены являются усредненными. Для уточнения стоимости по интересующей позиции, пожалуйста, свяжитесь с нами по телефону в Санкт-Петербурге +7 (812) 905-30-62" />
        <Spacer />
        <Text
          sx={{
            fontSize: "16px",
